  ...
  return (
    <>
      {user.map((user, index) => {
        return (
          <div key={index}>
            <ListTemp onClick={(e) => handleInput(user.hotel_brand_id)}>
              {user.hotel_brand_id}
            </ListTemp>
            <p>{user.brand_name}</p>
          </div>
...
const Form = () => {
  return (
    <>
      <form>
        <input type="text" placeholder="startDate" name="startDate" />
        <input type="text" placeholder="endDate" name="endDate" />
        <p>Enter Number of Occupants</p>
        <input type="num" placeholder="occupants" name="occupants" />
      </form>
    </>
  );
};
...
const CustomerPage = () => {
  return (
    <>
      <HeaderTitle>Customer Page</HeaderTitle>
      <Container>
        <SelectBox>
